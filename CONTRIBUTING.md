...
There are a few things that can be done to resolve any questions or problems you might have.
 ...
 - Join our patternfly-sandbox-ng channel on [Slack](http://slack.patternfly.org)
...
##### Setting up the environment for the first time:
 ...
 - Clone patternfly-sandbox-ng from github
   git clone https://github.com/patternfly/patternfly-sandbox-ng
   
 - Within the patternfly-sandbox-ng directory, run:
   npm install
...
1. Generate a Github personal access token
   ...
   * Description: "patternfly-sandbox-ng"
   * Scopes: Check the **"public_repo"** option
   * Hit generate to generate the token
2. Enable Travis builds
   * Visit `https://travis-ci.org/<github username>/patternfly-sandbox-ng`
...
4. Copy your test page url to share in your pull request
   * Rawgit will now serve the test pages for your feature branch at the following url:
      * `https://rawgit.com/<github username>/patternfly-sandbox-ng/<branch>-dist/dist-demo/`
...
- Encourage and ensure design remains an integral part of the review process and pull in designers for review as needed (you can leverage [@patternfly/patternfly-sandbox-ng-ux](https://github.com/orgs/patternfly/teams/patternfly-sandbox-ng-ux) if there is no known associated designer).
...
[github]: https://github.com/patternfly/patternfly-sandbox-ng/
[github-issues]: https://github.com/patternfly/patternfly-sandbox-ng/issues
[github-pr]: https://github.com/patternfly/patternfly-sandbox-ng/pulls
