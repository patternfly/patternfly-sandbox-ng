...
import { ListBase } from 'patternfly-ng/list';
 ...
 * Optional:
 * <code><pre>
 * import { ListEvent, TreeListConfig } from 'patternfly-sandbox-ng/list';
 * </pre></code>
 *
 * Note: The tree-list component has issues with AOT and mobx-autorun.directive, introduced by angular-tree-component,
...
export class TreeListComponent extends ListBase implements DoCheck, OnInit {
   ...
   *
   * @param nodeLevel The level of the given node in the tree
